...
class PaymentController extends Controller
{
    ...
    public function get_address(){
        ...
        $get_address = DB::table('straks')->where('address_status', "new")->first()->value('straks_address');
        DB::table('straks')->where('straks_address', $get_address)->update('address_status' , 'pending');
        return $get_address;
    }
