                ...
                <div id="page-wrapper">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group row {{ $errors->has('default_withdrawal_account')? 'has-error':'' }}">
                                ...
                                <div class="col-sm-8">
                                    <fieldset>
                                        ...
                                        <label><input type="radio" id="default_straks" value="straks" name="default_withdrawal_account" @if(withdrawal_preference() == 'straks') checked="checked" @endif > @lang('app.straks') </label> <br />
                                    </fieldset>
                            ...
                            <div class="config_wrap straks-wrap" style="display: @if(withdrawal_preference() == 'straks') block @else none @endif;">

                                <div class="form-group row {{ $errors->has('straks_address')? 'has-error':'' }}">
                                    <label for="straks_address" class="col-sm-4 control-label">@lang('app.straks_address')</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="straks_address" value="{{ withdrawal_preference('straks_address') }}" name="straks_address" placeholder="@lang('app.straks_address')">
                                        {!! $errors->has('straks_address')? '<p class="help-block">'.$errors->first('straks_address').'</p>':'' !!}
                                    </div>
                                </div>
